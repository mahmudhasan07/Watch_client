    ...
    return (
        <section className="relative my-2">
            <div className="h-[600px] flex justify-center items-center">
                <motion.img src={banner} initial={{ width: "35%" }} animate={{ width: "100%", height: "100%", filter: { brightness: "80%" } }} transition={{ delay: 4.4, duration: 2, ease: "anticipate" }} className="object-cover opacity-95 object-center"></motion.img>
            </div>
