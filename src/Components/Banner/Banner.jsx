    ...
    return (
        <section className="relative my-2">
            <div className="h-[600px] flex justify-center items-center">
                <motion.img src="https://res.cloudinary.com/daudgshta/image/upload/v1709894612/watch_banner_vfmxvp.png" initial={{ width: "35%" }} animate={{ width: "100%", height: "100%", filter: { brightness: "80%" } }} transition={{ delay: 4.8, duration: 2, ease: "anticipate" }} className="object-cover object-center brightness-75"></motion.img>
            </div>
