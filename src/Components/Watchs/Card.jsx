    ...
    return (
        <div
           ...
           id='card' className={`card w-96 h-96   text-white space-y-2 rounded-xl`}>
            ...
            <div id='cardinfo' className='px-1 text-center'>
                ...
                <button onClick={()=> navigate(`model=${card?.Watch_name}`)} className='btn text-white font-semibold text-lg' id='detailsBTN'>Details</button>
            </div>
