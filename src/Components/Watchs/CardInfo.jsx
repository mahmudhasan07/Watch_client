        ...
        <section className='my-10'>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 lg:my-14 md:my-9 my-6'>
                ...
                <motion.div initial={{ x: "200%", opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 1, duration: 1.5, ease: "backOut" }}
                    ...
                    <h1 className='text-[#FC6F2F]'>Type Of Watch :  <span className='text-[#515839]'> {array?.watch_type}</span></h1>
                    <h1 className='text-[#FC6F2F]'>Color :  <span className='text-[#515839]'> {array?.watch_color}</span></h1>
