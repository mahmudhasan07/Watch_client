                ...
                <AnimatePresence key={loading}>
                    {
                        loading == true ?
                            <motion.div onAnimationComplete={() => setLoading(false)} className="relative p-2 lg:h-96 h-28">
                                ...
                                <motion.img initial={{ width: "30%", y: "400%", opacity: 0 }} animate={{ width: "30%", y: "120%", height: "80%", x: "200%", opacity: 1 }} transition={{ delay: 2.5, duration: 2, ease: "backOut" }} exit={{ opacity: 0 }} src={image4} className="absolute object-cover" ></motion.img>
                                <motion.img initial={{ width: "35%", y: "400%", opacity: 0 }} animate={{ width: "35%", y: "60%", x: "100%", opacity: 1 }} transition={{ delay: 3, duration: 3, ease: "backOut" }} exit={{ opacity: 1 , transition:{delay:.1}}} onAnimationComplete={() => setLoading(false)} src={image5} className="absolute object-cover" ></motion.img>
                            </motion.div>
                            :
                            ""
                    }
